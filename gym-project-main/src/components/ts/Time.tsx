    ...
    <Box
      ...
      sx={{
        ...
        "&:before": {
          ...
          left: "-100%",
          background:
            "linear-gradient(45deg, rgba(255,255,255,0.1), rgba(0,0,0,0))",
    ...
    >
      ...
      >
        ...
        <Typography variant="body1" gutterBottom sx={{ color: "#ddd" }}>
          Avoid crowds and book your gym slot at the time that suits you best.
          Real-time updates and a seamless booking experience.
        </Typography>
        <List>
          <ListItem>
            <ListItemIcon
            ...
            <ListItemText
              primary="Real-time gym slot booking"
              sx={{ color: "#fff" }}
            />
          </ListItem>
          <ListItem>
            ...
            <ListItemText
              primary="Up-to-date capacity information"
              sx={{ color: "#fff" }}
            />
          </ListItem>
          <ListItem>
            ...
            <ListItemText
              primary="Seamless, easy-to-use interface"
              sx={{ color: "#fff" }}
            />
          </ListItem>
        </List>
      ...
      >
        <img
          src="https://images.unsplash.com/photo-1627483298235-f3bac2567c1c?q=80&w=1740&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
